...
html,body{margin:0;width:100%;height:100%;overflow:hidden;background:#050608}.composition{position:relative;width:1920px;height:1080px;overflow:hidden}.footage{position:absolute;inset:0;width:1920px;height:1080px;object-fit:cover;filter:saturate(1.14) contrast(1.06) brightness(1.035)}.crop-atl{object-position:51% 50%}.crop-min{object-position:50% 50%}.comparison{position:absolute;inset:0;display:grid;grid-template-columns:1fr 1fr;gap:8px;background:#050608}.comparison img{width:100%;height:1080px;object-fit:cover;filter:saturate(1.14) contrast(1.06) brightness(1.035)}.comparison img:first-child{object-position:56% 50%}.comparison img:last-child{object-position:53% 50%}.edge{position:absolute;inset:0;pointer-events:none;box-shadow:inset 0 0 90px rgba(0,0,0,.22)}
