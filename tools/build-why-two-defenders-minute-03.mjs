...
const visuals = [
  ...
  video("con-live-setup", "con", starts[0], 1.2, 0),
  video("con-setup-slow", "conSetupSlow", starts[0] + 1.2, 2.5, 0),
  freeze("con-low-defender-freeze", "conLow", starts[0] + 3.7, 2.0),
  video("con-drive-slow", "conDriveSlow", starts[0] + 5.7, 3.0, 0),
  freeze("con-route-preview", "conRoute", starts[0] + 8.7, 2.0),
  video("con-pass-preview", "conPassSlow", starts[0] + 10.7, 3.67, 0),
  freeze("con-release-preview", "conRelease", starts[0] + 14.37, voiceDurations[0] - 14.37),

  // Resume from the open route, slow the delivery, and complete the reverse layup only once.
  freeze("con-route-explanation", "conRoute", starts[1], 2.0),
