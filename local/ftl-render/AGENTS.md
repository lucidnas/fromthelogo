...
node ../../tools/render-hyperframes-clean.mjs  # FTL render wrapper; cleans Puppeteer/Chrome workers
npx hyperframes lint         # validate compositions (errors + warnings)
npx hyperframes lint --json  # machine-readable output for CI
npx hyperframes docs <topic> # reference docs in terminal
```

For FTL production renders, do not run raw `npx hyperframes render`; use
`node ../../tools/render-hyperframes-clean.mjs ...` from this directory so renderers are cleaned
